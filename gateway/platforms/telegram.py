...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "PACE stopped Telegram polling after %d retries. "
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if not acquired:
                ...
                message = (
                    "Another local PACE gateway is already using this Telegram bot token"
            ...
            try:
                ...
                from pace_cli.commands import telegram_menu_commands
    ...
    async def send_update_prompt(
        ...
        Used by the gateway ``/update`` watcher when ``pace update --gateway``
