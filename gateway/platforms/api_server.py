...
- GET  /v1/models                  — lists pace-agent as an available model
...
class APIServerAdapter(BasePlatformAdapter):
    ...
    def _create_agent(
        ...
        gateway platforms), falling back to the pace-api-server default.
        """
    ...
    async def _handle_health(self, request: "web.Request") -> "web.Response":
        ...
        return web.json_response({"status": "ok", "platform": "pace-agent"})

    async def _handle_models(self, request: "web.Request") -> "web.Response":
        """GET /v1/models — return pace-agent as an available model."""
