...
class WhatsAppAdapter(BasePlatformAdapter):
    ...
    # Default bridge location relative to the pace-agent install
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            if not acquired:
                ...
                message = (
                    "Another local PACE gateway is already using this WhatsApp session"
        ...
        try:
            ...
            if data.get("status") != "connected":
                ...
                for attempt in range(15):
                    ...
                    print(f"[{self.name}]   If session expired, re-pair: pace whatsapp")
