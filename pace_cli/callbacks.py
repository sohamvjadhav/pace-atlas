...
from pace_cli.banner import cprint, _DIM, _RST
from pace_cli.config import save_env_value_secure
...
def prompt_for_secret(cli, var_name: str, prompt: str, metadata=None) -> dict:
    ...
    The secret is stored in ~/.pace/.env and never exposed to the model.
    """
