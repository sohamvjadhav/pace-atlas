"""PACE CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.pace/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "PACE Atlas"          # Banner title, status display
      welcome: "Welcome to PACE Atlas"          # Shown at CLI startup
      goodbye: "Goodbye! ⚡"              # Shown on exit
      response_label: " ⚡ PACE "       # Response box header label
...
.. code-block:: python
    ...
    from pace_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "PACE Atlas"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.pace/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic PACE gold/kawaii (the current look)
...
Drop a YAML file in ``~/.pace/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic PACE — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "PACE Atlas",
            "welcome": "Welcome to PACE Atlas! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚡",
            "response_label": " ⚡ PACE ",
            "prompt_symbol": "❯ ",
