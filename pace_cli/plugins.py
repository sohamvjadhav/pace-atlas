...
1. **User plugins**   – ``~/.pace/plugins/<name>/``
2. **Project plugins** – ``./.pace/plugins/<name>/`` (opt-in via
...
def get_plugin_toolsets() -> List[tuple]:
    ...
    Used by the ``pace tools`` TUI so plugin-provided toolsets appear
