...
import pace_cli.auth as auth_mod
...
def auth_add_command(args) -> None:
    ...
    raise SystemExit(f"`pace auth add {provider}` is not implemented for auth type {requested_type} yet.")
...
def _interactive_auth() -> None:
    """Interactive credential pool management when `pace auth` is called bare."""
