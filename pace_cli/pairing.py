...
Usage:
    pace pairing list              # Show all pending + approved users
    pace pairing approve <platform> <code>  # Approve a pairing code
    pace pairing revoke <platform> <user_id> # Revoke user access
    pace pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle pace pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: pace pairing {list|approve|revoke|clear-pending}")
        print("Run 'pace pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'pace pairing list' to see pending codes.\n")
