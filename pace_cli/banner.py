...
def _skin_color(key: str, fallback: str) -> str:
    ...
    try:
        from pace_cli.skin_engine import get_active_skin
...
from pace_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
def check_for_updates() -> Optional[int]:
    ...
    ``~/.pace/.update_check``).  Returns the number of commits behind,
    or ``None`` if the check fails or isn't applicable.
    """
    hermes_home = get_hermes_home()
    repo_dir = hermes_home / "pace-agent"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    agent_name = _skin_branding("agent_name", "PACE Atlas")
