...
| | |
|---|---|
| Source | Optional — install with `pace skills install official/finance/stocks` |
...
```
SCRIPT=~/.pace/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.pace/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
