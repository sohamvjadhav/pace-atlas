...
| | |
|---|---|
| Source | Optional — install with `pace skills install official/blockchain/hyperliquid` |
...
Helper script: `~/.pace/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.pace/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python3 ~/.pace/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.pace/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
