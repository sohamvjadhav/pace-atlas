...
| | |
|---|---|
| Source | Optional — install with `pace skills install official/blockchain/evm` |
...
Helper script path: `~/.pace/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.pace/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.pace/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.pace/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
