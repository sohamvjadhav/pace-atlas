...
| | |
|---|---|
| Source | Optional — install with `pace skills install official/blockchain/solana` |
...
Helper script path: ~/.pace/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.pace/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.pace/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.pace/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.pace/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.pace/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.pace/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
