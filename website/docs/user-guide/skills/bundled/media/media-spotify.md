...
Control the user's Spotify account via the Hermes Spotify toolset (7 tools). Setup guide: https://pace-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `pace auth spotify` again.
