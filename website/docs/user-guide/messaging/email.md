...
| **Duplicate replies** | Ensure only one gateway instance is running. Check `pace gateway status`. |
...
- The password is stored in `~/.pace/.env` — protect this file (`chmod 600`)
